    ...
    public partial class AddLoginHistory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IssueStatusHistoryId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueStatusHistory", x => x.IssueStatusHistoryId);
                    table.ForeignKey(
                        name: "FK_IssueStatusHistory_AspNetUsers_ChangedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueStatusHistory_ChangedById",
